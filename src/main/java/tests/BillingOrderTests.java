...
public class BillingOrderTests extends BaseTest {
	...
	public void TC1() throws Exception {
		...
		//values arrange  given 
		//fill act when 
		//click 
		//validate assert then 
		BillingOrder billingOrder= new BillingOrder("John", "Smith", "mail@email.com", "88002000500", "Kanzas", "54321", State.AK, "State", "District", 1, "Comment")  ;
		
		var billingOrderPage = new BillingOrderPage(driver);
		billingOrderPage.sendOrder(billingOrder);
		
		Assert.assertTrue(billingOrderPage.isSuccessMessageDisplayed(1000));
