...
public class TestBlankFormPage extends BasePage {
	...
	public TestBlankFormPage sendForm(String firstName, String lastName, String email, String comment)
			throws Exception {
	...
	@Step("Submit form with object")
	public TestBlankFormPage sendForm(TestBlankForm form) throws Exception {
